...
[here](https://github.com/complexdatacollective/working-with-data/blob/main/networkCanvasExport.zip).

### Export data from Network Canvas

The first step in exporting data from Network Canvas is to navigate to
the Manage and Export Session data in the Interviewer app. ![Manage and
Export Session](Images/NC_DataExport0.png)  

Next, you’ll indicate which sessions you want to export by selecting the
appropriate cards and clicking “Export Selected To File.” ![Select
Network Canvas Sessions for Export](Images/NC_DataExport1.png)
...
using examples derived from an egor
[vignette](https://cran.r-project.org/web/packages/egor/vignettes/using_egor.html)
