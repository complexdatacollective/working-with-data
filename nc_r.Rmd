...
**I FEEL LIKE WE SHOULD BRIEFLY EXPLAIN THE CONTEXT OF THESE DATA TO READERS. IT WILL HELP THEM UNDERSTAND THE NAMES OF CERTAIN COLUMNS, ESPECIALLY IN THE ANALYSIS SECTION**
...
![*A Directory of Exported Network Canvas CSVs*](nc_directory_list.png){width=90%}
...
path_to_data <- "~/Desktop/netwrite_debug/nc_site/networkCanvasExport"
```
...
### Note that this path will almost certainly be different on your own computer
path_to_protocol <- "~/Desktop/netwrite_debug/nc_site/IJE_RADAR_Protocol.netcanvas"
```
